...
{
    [TestClass]
    public class SetAssetScriptTransactionTests
    {
        [TestMethod]
        public void SetAssetScriptTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<SetAssetScriptTransaction>();
            var tr1 = new SetAssetScriptTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new SetAssetScriptTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
