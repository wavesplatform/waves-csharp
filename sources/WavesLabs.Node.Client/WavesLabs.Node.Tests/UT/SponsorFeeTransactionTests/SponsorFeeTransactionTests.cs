...
{
    [TestClass]
    public class SponsorFeeTransactionTests
    {
        [TestMethod]
        public void SponsorFeeTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<SponsorFeeTransaction>();
            var tr1 = new SponsorFeeTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new SponsorFeeTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
