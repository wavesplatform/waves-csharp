...
{
    [TestClass]
    public class GenesisTransactionTests
    {
        [TestMethod]
        public void GenesisTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<GenesisTransaction>();
            var tr1 = new GenesisTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new GenesisTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
