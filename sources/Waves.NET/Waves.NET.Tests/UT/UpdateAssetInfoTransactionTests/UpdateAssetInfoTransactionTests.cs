...
{
    [TestClass]
    public class UpdateAssetInfoTransactionTests
    {
        [TestMethod]
        public void UpdateAssetInfoTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<UpdateAssetInfoTransaction>();
            var tr1 = new UpdateAssetInfoTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new UpdateAssetInfoTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
