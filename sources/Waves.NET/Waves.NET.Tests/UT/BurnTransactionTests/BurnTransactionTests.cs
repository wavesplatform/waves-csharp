...
{
    [TestClass]
    public class BurnTransactionTests
    {
        [TestMethod]
        public void BurnTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<BurnTransaction>();
            var tr1 = new BurnTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new BurnTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
