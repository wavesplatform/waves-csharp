...
namespace Waves.NET.Tests.UT
{
    ...
    {
        [TestMethod]
        public void TransferTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<TransferTransaction>();
            var tr1 = new TransferTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            var tr2 = new TransferTransaction { Proofs = new List<Base58s> { Base58s.As("abcd") } };
            //Equals
