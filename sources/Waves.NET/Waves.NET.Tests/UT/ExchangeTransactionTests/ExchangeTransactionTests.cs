...
namespace Waves.NET.Tests.UT
{
    ...
    {
        [TestMethod]
        public void ExchangeTransactionEqualsAndGetHashCodeTest()
        {
            var hs = new HashSet<ExchangeTransaction>();
            var tr1 = new ExchangeTransaction { Order1 = new Order { Proofs = new List<Base58s> { Base58s.As("abcd") } } };
            var tr2 = new ExchangeTransaction { Order1 = new Order { Proofs = new List<Base58s> { Base58s.As("abcd") } } };
            //Equals
            ...
            //Not equals
            tr2.Order1.Proofs.Add(Base58s.As("xyz"));
